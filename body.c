...
int main() {
    struct Catatan catatan[100]; // Asumsikan maksimal 100 catatan
    ...
    do {
        hapusLayar();
        tampilkanHeaderMenu();
        tampilkanCatatan(catatan, jumlahCatatan); // Menampilkan daftar catatan
        printf("\n\n\n");
        tampilkanMenuUtama();
        printf("\t\t\tPilihan Anda: ");
        scanf("%d", &pilihan);
        ...
        switch (pilihan) {
            ...
            case 2: {
                ...
                catatan[jumlahCatatan++] = catatanBaru; // Menambah catatan baru ke dalam array
                break;
            }
            case 3: {
                hapusLayar();
                ...
                simpanCatatanKeFile(catatan, jumlahCatatan); // Simpan perubahan ke dalam file
                break;
            }
            case 4: {
                hapusLayar();
        ...
        getchar(); // Mengonsumsi karakter baris baru yang tersisa di buffer
